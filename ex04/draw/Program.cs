...
namespace draw
{
    class Program
    {
        ...
        public static void draw1(int number, char c)
        {
            ...
            {
                Hori(1, c); Hori(number - 2, ' '); Hori(1, c); Console.WriteLine();
            }
            //last line;
            Hori(number, c); Console.WriteLine();
        }
        ...
        public static void draw3(int number, char c)
        {
            ...
            //1-line
            //int space1 = number + 1;
            Hori(1, c); Hori(number + 1, ' '); Hori(1, c); Hori(number + 1, ' '); Hori(1, c); Console.WriteLine();
            //i-line
            int space2 = number + 1;
            int space3 = 1;
            for (int i = 1; i <= number / 2; i++)
            {
                ...
                if (i == number / 2)
                {
                    Hori(i + 1, ' '); Hori(1, c); Hori(number * 2 - i * 2 + 1, ' '); Hori(1, c);
                }
            }
        ...
        public static void draw6(int number, char c)
        {
            ...
            for (int i = 0; i < number; i++)
            {
                ...
                Hori(topspace1, ' '); Hori(1, c); Hori(topspace2 + 1, ' '); Hori(1, c); Console.WriteLine();
                topspace1 = topspace1 + 1;
                topspace2 = topspace2 - 2;
            }
        ...
        {
            Hori(number * 2 + 3, c); Console.WriteLine();
            int topspace2 = number * 2 - 2;
            int topspace1 = 1;
            //draw X
            //top mid line
        ...
        static void draw9(int number, char c)
        {
            ...
            // last line 2n-1 star 
            {
                Hori(number*2-1 , ' '); Hori(1, c); Console.WriteLine();
                //bot mid line
                ...
                for (int i = 0; i < number; i++)
                {
                    if (i == number/2)
                    {
                     Hori(botspace1, ' '); Hori(1, c); Hori(botspace2, c); Hori(1, c); Console.WriteLine();
                     botspace1 = botspace1 - 1;
                     botspace2 = botspace2 + 2;
                    }
                    Hori(botspace1, ' '); Hori(1, c); Hori(botspace2, ' '); Hori(1, c); Console.WriteLine();
